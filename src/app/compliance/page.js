...
import "./cleaning.css";
import ClinicalHero from "./components/Hero/ClinicalHero";
import Compliance from "./components/ComplianceServices/ComplianceServices";
import { Footer } from "../../../components";
import { CTA } from "../healthcare-staffing/components";

export default function ClinicalCleaningPage() {
  return (
    <div>
      <ClinicalHero />
      <Compliance />
